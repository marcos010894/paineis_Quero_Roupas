        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="avaliation.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Avaliações</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <a href="andamento.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="font-size:15px;">Pedidos em Andamento</p>
                </a>
              </li>
              <li class="nav-item">
...
<!-- Modal financeiro -->
<div class="modal fade" id="finaceiroModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Fatura em aberto</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <span style="color:red;"> Atenção </span> você tem uma fatura em aberto, va na aba financeiro para consoltar.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <a href="fatura.php">
          <button type="button" class="btn btn-success" onclick="financeiroLink()">Pagar</button>
        </a>
      </div>
    </div>
  </div>
